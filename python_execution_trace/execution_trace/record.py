...
from python_execution_trace.execution_trace.constants import RECORD_FN_NAME, RETVAL_NAME, MANGLED_FN_NAME
from python_execution_trace.execution_trace.utils import strip_indent
