...
from python_execution_trace.execution_trace.utils import find_indent_level, strip_indent
...
class TestUtils(unittest.TestCase):
    ...
    @mock.patch('python_execution_trace.execution_trace.utils.find_indent_level')
