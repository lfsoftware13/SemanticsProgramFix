...
#
from python_execution_trace.execution_trace import record
from python_execution_trace.execution_trace.constants import SOURCE_DUMP_SCHEMA, EXECUTION_DUMP_SCHEMA, RECORD_FN_NAME
...
# Covers all supported syntax. See `python_execution_trace.execution_trace.tests.functions`
# package for context.
SYNTAX_TESTS = [
...
class TestRecord(unittest.TestCase):
    ...
    @classmethod
    def setUpClass(cls):
        cls.log_patcher = mock.patch('python_execution_trace.execution_trace.record.logger')
    ...
    def setUp(self):
        ...
        self.get_dump_file_patcher = mock.patch('python_execution_trace.execution_trace.record._get_dump_file')
    ...
    def test_syntax(self, f_module_name):
        ...
        f_module = importlib.import_module('python_execution_trace.execution_trace.tests.functions.%s' % f_module_name)
